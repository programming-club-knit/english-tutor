...
const Github = () => {
  return (
    <a
      ...
      className="fixed top-4 right-4 z-50 bg-gray-900 hover:bg-black text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 group"
